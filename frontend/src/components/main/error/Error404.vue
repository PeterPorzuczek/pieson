<template>
    <div class="error404">
      ...
      <h3 class="text-center text-white">{{'error.message' | translate}}</h3>
      <div class="text-center"> 
        <Button class="btn btn-warning btn-sm" @click="goHome">{{'error.home' | translate}}</Button>
      </div>
      <div class="text-center"> 
        <Button class="btn btn-info btn-sm" @click="backPage">{{'error.back' | translate}}</Button>
      </div>
    </div>
</template>
